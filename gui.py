...
class VentanaPrincipal(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Automatizacion Excel")
        ...
        self.txtCarpetaFuente = tk.Text(self.frame_principal, width=50, height=1, state="disabled")
        self.txtCarpetaFuente.grid(row=0, column=1, pady=10, padx=5)

        self.txtStockXDepo = tk.Text(self.frame_principal, width=50, height=1, state="disabled")
        self.txtStockXDepo.grid(row=2, column=1, pady=10, padx=5)
        
        self.txtArchivoDestino = tk.Text(self.frame_principal, width=50, height=1, state="disabled")
        ...
        self.btnProcesar.grid(row=5, column=1, columnspan=2, pady=10)